...
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/courseindex.php');
...
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/courserelatedhints.php');

// Include the template content for the block regions.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/blockregions.php');

// Include the content for the back to top button.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/backtotopbutton.php');

// Include the content for the Boost Union footer buttons.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/footerbuttons.php');

// Include the content for the scrollspy.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/scrollspy.php');

// Include the template content for the footnote.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/footnote.php');

// Include the template content for the static pages.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/staticpages.php');

// Include the template content for the accessibility pages.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/accessibilitypages.php');

// Include the template content for the footer button.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/footer.php');

// Include the template content for the JavaScript disabled hint.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/javascriptdisabledhint.php');

// Include the template content for the info banners.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/infobanners.php');

// Include the template content for the navbar.
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/navbar.php');
...
require_once(dirname(__DIR__, 2) . '/boost_union/layout/includes/smartmenus.php');
