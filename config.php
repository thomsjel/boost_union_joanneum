...
$THEME->name = 'boost_union_joanneum';
$THEME->scss = function ($theme) {
    return theme_boost_union_joanneum_get_main_scss_content($theme);
};
$THEME->parents = ['boost_union', 'boost'];
$THEME->extrascsscallback = 'theme_boost_union_joanneum_get_extra_scss';
$THEME->prescsscallback = 'theme_boost_union_joanneum_get_pre_scss';
